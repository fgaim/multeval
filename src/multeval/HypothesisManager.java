...
/**
 * System index 0 is the baseline system. Sentences having extra whitespace have
 * that whitespace normalized first during loadSentences() for both references
 * and hypotheses.
 *
 * @author jon
 */
public class HypothesisManager {
    ...
    private void loadHyps(String[] hypFiles, String sys) throws IOException {
        ...
        } else if (numOptRuns != hypFiles.length) {
        ...
        for (int iOpt = 0; iOpt < numOptRuns; iOpt++) {
            ...
            } else if (numHyps != hypsForOptRun.size()) {
